    ...
    return (
        <Card bordered={false} title="比赛进程">
            <Steps progressDot={true} direction="vertical">
                <Steps.Step status="finish" title="5月9日" description="开始报名" />
                <Steps.Step status="finish" title="5月9日 - 5月30日" description="筛选简历" />
                <Steps.Step status="finish" title="5月30日" description="停止报名" />
                <Steps.Step status="process" title="6月1日 - 6月2日" description="确认是否参赛" />
