        ...
        return (
            ...
            >
                ...
                {showTeamLeaderOperate && (
                    <Column
                        title="操作"
                        key="teamLeaderOperating"
                        render={renderTeamLeaderOperate}
                    />
                )}
                {showMemberOperate && (
...
export default connect(
    ({ teamInfo, user: { username }, user, router }: RootState) => {
        const showEditButton = router && router.location && router.location.pathname !== '/team';
