            ...
            <Tabs animated={false} tabBarStyle={{ textAlign: 'center' }}>
                ...
                <TabPane tab="注册" key="register">
                    ...
                    >
                        ...
                        <MobileCode
                            onSend={this.onRegisterSMSSend}
                            isSending={registerSMSSubmitting}
                        />
        ...
        return (
            <UserEntryLayout>
                <Card bordered={false} className="login">
                    <Switch>
                        <Route
                            path={`${this.props.match.url}/reset_pwd`}
                            render={this.renderResetPwdForm}
                        />
